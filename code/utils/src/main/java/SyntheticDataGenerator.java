...
public class SyntheticDataGenerator
{
    ...
    final static int NUMBER_OF_SAMPLES = 100;
    final static int CONF_NAME_LENGTH_MAX = 20;
    final static int CONF_NAME_LENGTH_MIN = 6;
    final static String DATE_PERIOD_START = "2022-01-01";
    final static String DATE_PERIOD_END = "2022-12-31";
    ...
    private static List<String[]> generateSyntheticData(int numRows)
    {
        ...
        for (int i = 0; i < numRows; i++)
        {
            ...
            String[] row = {eventName, country, city, startDate, endDate, sessionTypeListString};

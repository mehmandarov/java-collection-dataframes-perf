...
public class ConferenceExplorerTest
{
    ...
    {
        ConferenceExplorer explorer = new ConferenceExplorer(2023);
        MutableList<Conference> conferences = explorer.sortByDaysToEvent();
    ...
    {
        ConferenceExplorer explorer = new ConferenceExplorer(2023);
        MutableListMultimap<SessionType, Conference> bySessionType = explorer.groupBySessionType();
        ...
        RichIterable<Conference> difference =
                bySessionType.get(SessionType.TALK).toSet().difference(bySessionType.get(SessionType.WORKSHOP).toSet());
    ...
    {
        ConferenceExplorer explorer = new ConferenceExplorer(2023);
        ImmutableSet<String> flags = explorer.getCountries().collect(Country::flag).toImmutableSet();

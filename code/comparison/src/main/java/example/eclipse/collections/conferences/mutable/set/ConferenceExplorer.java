package example.eclipse.collections.conferences.mutable.set;
...
{
    private MutableSet<Conference> conferences;
    private MutableSet<Country> countries;
    ...
    public MutableSet<Conference> getConferences()
    {
        return this.conferences;
    }

    public MutableSetMultimap<Country, Conference> groupByCountry()
    {
        return this.conferences.groupBy(Conference::country);
    }

    public MutableSetMultimap<String, Conference> groupByCity()
    {
    ...
    public MutableSetMultimap<SessionType, Conference> groupBySessionType()
    {
        return this.conferences.groupByEach(Conference::sessionTypes);
    }

    public MutableSet<Country> getCountries()
    {

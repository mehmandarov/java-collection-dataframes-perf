package example.eclipse.collections.conferences.mutable.list;
...
{
    private MutableList<Conference> conferences;
    private MutableList<Country> countries;
    ...
    public MutableList<Conference> getConferences()
    {
        return this.conferences;
    }

    public MutableListMultimap<Country, Conference> groupByCountry()
    {
        return this.conferences.groupBy(Conference::country);
    }

    public MutableListMultimap<String, Conference> groupByCity()
    {
        return this.conferences.groupBy(Conference::city);
    }

    public MutableList<Conference> sortByDaysToEvent()
    {
        return this.conferences.toSortedListBy(Conference::daysToEvent);
    }

    public MutableListMultimap<SessionType, Conference> groupBySessionType()
    {
        return this.conferences.groupByEach(Conference::sessionTypes);
    }

    public MutableList<Country> getCountries()
    {

...
link:toc.adoc[⬆️ TOC] /
link:./02_03_05_memory_footprint_boxed_vs_primitive_map_of_sets.adoc[⬅️ Memory Footpring - Boxed vs. Primitive Sets] /
link:./02_03_07_mutable_vs_immutable_sets.adoc[➡️ Memory Footprint - Mutable vs. Immutable Sets] 🐢

...
link:toc.adoc[⬆️ TOC] /
link:./02_03_04_memory_footprint_boxed_vs_primitive_sets.adoc[⬅️ Memory Footpring - Boxed vs. Primitive Sets] /
link:./02_03_06_mutable_vs_immutable_sets.adoc[➡️ Memory Footprint - Mutable vs. Immutable Sets] 🐢
